...
static CGFloat grooveLayer_AnimationDuring = 0.3;
...
- (instancetype)initWithFrame:(CGRect)frame withDataModel:(CellDataModel *)dataModel block:(SKIndexBlock)block
{
...
- (void)createUI
{
    ...
    _startBtn = [[StartBtn alloc] initWithFrame:CGRectMake(self.width - btn_width-12, 36+(IPhoneX?44:22), btn_width, btn_width) withDataModel:_dataModel];
...
- (void)initSetButtonsView
{
    ...
    [btn_1 setImage:[[UIImage imageNamed:@"五角星"] initwithColor:UIColor.whiteColor] forState:UIControlStateNormal];
    
    btn_1.backgroundColor = SKThemeColor;
    btn_1.tag = 0;
    [btn_1 addTarget:self action:@selector(buttonActions:) forControlEvents:UIControlEventTouchUpInside];
    ...
    [btn_2 setImage:[[UIImage imageNamed:@"警告"] initwithColor:UIColor.whiteColor] forState:UIControlStateNormal];
    btn_2.backgroundColor = SKThemeColor;
    btn_2.tag = 1;
    [btn_2 addTarget:self action:@selector(buttonActions:) forControlEvents:UIControlEventTouchUpInside];
    ...
    [btn_3 setImage:[[UIImage imageNamed:@"Person Block-1"] initwithColor:UIColor.whiteColor] forState:UIControlStateNormal];
    btn_3.backgroundColor = SKThemeColor;
    btn_3.tag = 2;
    [btn_3 addTarget:self action:@selector(buttonActions:) forControlEvents:UIControlEventTouchUpInside];
    [btnsArray addObject:btn_3];
    
//    SpecialBtn *btn_4 = [[SpecialBtn alloc] initWithFrame:CGRectMake(0, 0, btn_width, btn_width)];
//    btn_4.layer.cornerRadius = btn_4.width / 2.0;
//    btn_4.layer.masksToBounds = YES;
//    btn_4.collisionBoundsType = UIDynamicItemCollisionBoundsTypeEllipse;
//    [btn_4 setImage:[[UIImage imageNamed:@"人"] initwithColor:UIColor.whiteColor] forState:UIControlStateNormal];
//    btn_4.backgroundColor = SKThemeColor;
//    btn_4.tag = 3;
//    [btn_4 addTarget:self action:@selector(buttonActions:) forControlEvents:UIControlEventTouchUpInside];
//    [btnsArray addObject:btn_4];
