...
//        [_bgBezierPath moveToPoint:CGPointMake(23, 0)];
//        [_bgBezierPath addArcWithCenter:CGPointMake(self.width, 0) radius:self.width/2 startAngle:M_PI endAngle:M_PI_2 clockwise:NO];
...
//        _bgShapeLayer.path = _bgBezierPath.CGPath;
        ...
        _arrowAnimationView = [[ArrowAnimationView alloc] initWithFrame:CGRectMake((self.width - _arrow_width)/2, (self.height - _arrow_height)/2, _arrow_width, _arrow_height)];
