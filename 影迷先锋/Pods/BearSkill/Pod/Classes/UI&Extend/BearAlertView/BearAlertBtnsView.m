...
- (void)layoutSubviews
{
    ...
    if (res_haveCancelBtn && res_haveConfirmBtn) {
        ...
        btn_width = self.frame.size.width / 2.0;
    ...
    _btns_horizontalSepLineV.frame = CGRectMake(0, 0, self.frame.size.width, 0.5);
